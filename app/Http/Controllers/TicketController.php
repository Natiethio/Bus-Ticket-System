  ...
  public function Tickets()
    ...
    public function email(){
      ...
      $details=[
        ...
        'body' => 'The ten digit ticket reference number is down below it is used as ticket reference for all passenger tickets you paid please have a noat of it or do not delete this email.You can also get QR code using the link Provided',
